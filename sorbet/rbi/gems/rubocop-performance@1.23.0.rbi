...
class RuboCop::Cop::Lint::UnusedMethodArgument < ::RuboCop::Cop::Base
  # source://rubocop/1.69.2/lib/rubocop/cop/lint/unused_method_argument.rb#75
  def not_implemented?(param0 = T.unsafe(nil)); end

  private

  # source://rubocop/1.69.2/lib/rubocop/cop/lint/unused_method_argument.rb#128
  def allowed_exception_class?(node); end

  # source://rubocop/1.69.2/lib/rubocop/cop/lint/unused_method_argument.rb#90
  def autocorrect(corrector, node); end

  # source://rubocop/1.69.2/lib/rubocop/cop/lint/unused_method_argument.rb#94
  def check_argument(variable); end

  # source://rubocop/1.69.2/lib/rubocop/cop/lint/unused_method_argument.rb#102
  def ignored_method?(body); end

  # source://rubocop/1.69.2/lib/rubocop/cop/lint/unused_method_argument.rb#107
  ...
  class << self
    ...
    # source://rubocop/1.69.2/lib/rubocop/cop/lint/unused_method_argument.rb#84
